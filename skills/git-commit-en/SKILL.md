---
name: git-commit-en
description: Generate one precise English Git commit message from the complete working-tree status and diff. Use when the user requests a commit message or asks to summarize current Git changes for a commit.
---

# English Git Commit Message

Generate exactly one English commit message from the repository state. Do not modify files, stage changes, create commits, or perform any other write operation.
